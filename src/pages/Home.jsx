...
const Home = () => {
  ...
  return (
    <Context.Provider value={[isActive, setIsactive]}>
      <div className='w-full h-auto flex justify-center relative flex-col'>
        <Nav />
        ...
        {/* Transparent Overlay */}
        {!isActive && (
          <div className=" w-full h-screen fixed z-10  inset-0 bg-white/80 flex flex-col justify-center items-center transition-all">
