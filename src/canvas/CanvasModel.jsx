...
const CanvasModel = () => {
  ...
  const handleAddtocart = () => {
    dispatch(addToCart({ "print": decal, "color": color }));
  };
    ...
    <colorContext.Provider value={[color, setColor, decal, setDecal]}>
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="lg:hidden absolute top-4 right-4 flex space-x-2">
          <button 
            onClick={handleAddtocart}
            className="px-4 py-2 bg-white text-black rounded-lg shadow-lg font-medium text-sm hover:bg-gray-100 active:scale-95 transition-all duration-200"
          >
            Add to Cart
          </button>

          <button className="px-4 py-2 bg-white text-black rounded-lg shadow-lg font-medium text-sm hover:bg-gray-100 active:scale-95 transition-all duration-200">
            Buy Now
          </button>
        </div>
